...
// define an interface representing the data that we're going to be working with that are returned from the API
interface Server {
    id: number;
    name: string;
    category: string;
...
const PopularChannels: React.FC<Props> = ({ open }) => {
    ...
    // initiate the fetchData() function whenever we use this component
    useEffect(() => {
        fetchData();
    }, []);
